    ...
    <div id='about' className="container about">
      <div className="row mt-5 justify-content-center align-items-center my-5">
        ...
        <div className="col-sm-12 col-md-4 text-star mx-5">
          ...
          <p>
            I have spent my life consistently learning, growing, and exploring as a musician and I found that this directly correlates to being a successful software engineer. I have spent the last decade combining my experiences in music with a career in retail before I made the pivot into the Fullstack Web Development program at&nbsp;
